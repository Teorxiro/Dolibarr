...
/**
 * \file    test/phpunit/ModulebuilderFunctionalTest.php
...
/**
 * Class ModulebuilderFunctionalTest
 *
 ...
 *
 * @package Testmodulebuilder
 */
class ModulebuilderFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modModulebuilder')->click();
		} else {
			// Disable the module
			$this->byHref('modModulebuilder')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/modulebuilder/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('modulebuilder/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/modulebuilder/admin/about.php');
		$this->authenticate();
		return $this->assertContains('modulebuilder/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('modulebuilderwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modModulebuilder_ModulebuilderTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modModulebuilder_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
