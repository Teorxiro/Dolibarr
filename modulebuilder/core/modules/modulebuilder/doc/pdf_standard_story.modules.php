...
/**
 *  \file       core/modules/modulebuilder/doc/pdf_standard.modules.php
...
class pdf_standard_story extends ModelePDFStory
{
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->modulebuilder->dir_output.'/story') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->modulebuilder->dir_output.'/story';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->modulebuilder->dir_output.'/story/'.$objectref;
